...
const StudentProfile = ({ student, referrals }: StudentProfileTypes) => {
  ...
  // State
  const [displayEditStudentProfileModal, setDisplayEditStudentProfileModal] =
    useState(false);
        ...
        <div className={classes.userDetails}>
          <div>
            <div className={classes.userInfo}>
              ...
              <div>
                <h3>{capitalize(student?.full_name)}</h3>
                <div className={classes.iconTextContainer}>
                  ...
                  <div>
                    ...
                    <span>Referral level: {referrals?.level_name}</span>
                  </div>
                </div>
              </div>
            </div>
