...
const StudentProfile = () => {
    ...
    const [displayEditStudentProfileModal, setDisplayEditStudentProfileModal] = useState(false)
    ...
    return (
        <>
            {displayEditStudentProfileModal && (
                <AcceptedModal
                    onClick={() => {
                        setDisplayEditStudentProfileModal(false)
                    }}
                    body={
            ...
            >
                <div className={classes.userDetails}>
                    <div>
                        ...
                        <div className={classes.links}>
                            ...
                            <div>
                                ...
                                <a href={activeStudent?.linkedinProfileUrl} target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                        <Button type='secondary' onClick={() => setDisplayEditStudentProfileModal(true)}>Edit student profile</Button>
                    </div>
                </div>
            </ProfileSectionContainer>
        </>
